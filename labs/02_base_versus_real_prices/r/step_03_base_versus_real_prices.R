...
while (abs(sum(q_gva_2020$Q_REAL_GVA_2020_2015[81:84]) - a_gva_2020$Poland[which(a_gva_2020$TIME == 2015)]) < 0.01) {
  if (abs(sum(q_gva_2020$Q_REAL_GVA_2020_2015[81:84]) < a_gva_2020$Poland[which(a_gva_2020$TIME == 2015)])) {
    q_gva_2020$Q_REAL_GVA_2020_2015[117] <- q_gva_2020$Q_REAL_GVA_2020_2015[117]
  }
}
